            ...
            body: Column(
              ...
              children: [
                Expanded(
                  flex: 0,
                  child: Padding(
                    padding: const EdgeInsets.only(top: 64.0, bottom: 27.0),
                    child: GestureDetector(
                      child: CircleAvatar(
                        radius: AppConstants.loginLogoRadius,
                        backgroundImage: imagePath.isEmpty? NetworkImage(
                            'https://masterbundles.com/wp-content/uploads/2023/03/reestaurent-ai-676.jpg'): FileImage(File(imagePath)) as ImageProvider,
                      ) ,
                      onTap: () {
